  ...
  if (loading) {
    return (
      <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20 h-full flex flex-col min-w-0">
        <h3 className="text-lg font-semibold text-white mb-4">Pronóstico por Hora - Hoy</h3>        <div className="hidden lg:grid lg:grid-cols-[repeat(auto-fit,minmax(100px,1fr))] gap-4 flex-1 items-center">
          {[...Array(6)].map((_, i) => (
